            ...
            <div class="col-md-12" style="width:1350px; height:00px;">
                <div class="card" id="invoice" style="height:880px;">
                    <div class="card-header bg-transparent header-elements-inline">
                        <h6 class="card-title text-primary">Phoenix Cab Service Invoice</h6><img src="assets/img/Phoenix.svg" class="img-fluid rounded-start" alt="..." style="width:40px; height:40px; position: absolute;
left: 18.57%;
                    ...
                    <div class="table-responsive">
                        <table class="table table-lg">
                            ...
                            <tbody>
                                <tr>
                                    <td>
                                        <h6 class="mb-0"><%=Depature %> To <%=Destination %></h6> <span class="text-muted">One Way Trip with First Class Facilities of Phoenix Cab Service(All Items Included).
                                           </span>
                                    </td>
                                    <td>$<%=price %>.00 U.S</td>
                                    <td><%=passenger %></td>
...
left: 10.57%;
right: 85.2%; margin-bottom:1px; margin-top:8px;"><br><span style="color:blue; font-size:15px; margin-top:0px; margin-left:109px;">Phoenix Cab Service</span>
...
<%=DateTime %></div>
                    ...
                    <div class="card-footer" align="center"> <span class="text-muted">@2022 Phoenix Cab Service. All Rights Reserved.</span> </div>
                </div>
            </div>
        </div>
    </div>
