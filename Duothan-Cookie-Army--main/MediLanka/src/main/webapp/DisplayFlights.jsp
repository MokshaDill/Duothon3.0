...
while(rs.next()){
      ...
      <nav id="navbar" class="navbar">
        <ul>
          <li><a href="index.jsp" class="active">Home</a></li>
                   <li><a href="Cabs,jsp" class="active">Cabs</a></li>
	...
	e.printStackTrace();
          ...
          %>
               ...
               <a href="#"> </a>
                           <ul>
				<li><a href="adminDashboard/html/pages-profile.jsp">Manage Account</a></li>
  ...
  <section id="hero" class="hero d-flex align-items-center" style="margin-bottom: -270px;
    ...
    <ul>
            <li class="dropdown"><a href="#"><span>Pickup</span> </a>
                <ul>
       ...
       <input type="text" name="From" placeholder="Colombo" class="text-form1" id="myInput" >
      </div>  
    ...
    <ul>
              <li class="dropdown"><a href="#"><span>Destination</span> </a>
                <ul>
<li><a href="#" >Colombo</a></li>
                  <li><a href="#" >Gampaha</a></li>
                  <li><a href="#" >Kandy</a></li>
            ...
            <input type="text" name="To" placeholder="Jaffna" class="text-form1" id="myInput1">
      </div>
      ...
      <input type="datetime-local" id="DateLocal" class="text-form1" name="date">
       ...
       <button type="submit" class="btn btn-primary">Show Taxis</button>
           </div>
  ...
  <section>
  <!-- section -->
  <div class="data-ex" style="color:black; margin-top:220px;margin-left:50px; " width><h4 style="color: #3333ff;">Here's why travelers choose<br> Phoenix Cab Service<h4>
...
try {
		    ...
		    sql ="Select * from trips where Depature='"+session.getAttribute("depature")+"' AND Destination='"+session.getAttribute("Destination")+"'";
...
border-radius: 15px; ">
        ...
        <table >        <h3  style="align-items:center; color:blue;">Discount : <%=rs.getString("Offer") %>%<h3>
						<hr>
                           <tr>
                       <td> Offer ID</td>
                        <td><%=rs.getString("OfferID") %></td></tr>
       <tr><td><%=rs.getString("Depature") %>  <img class="form-img" src="assets/img/Depart.svg" alt="" style="width:25px; height:25px;"></td>  <td><%=rs.getString("Destination") %>  <img class="form-img" src="assets/img/Return.svg" alt="" style="width:25px; height:25px;"></td></tr>     
        ...
        <p style="margin-bottom:0">GET THE OFFER NOW!</p>
        <p class="card-text"  style="margin-bottom:0.2rem"><small class="text-muted">Last updated 3 mins ago</small></p>
...
border-radius: 15px;">
  ...
  <tr><td >Offer ID</td><td ><input type="text" name="id" style="width:75px; border-radius:15px; heigth:35px; margin-left:10px; text-align:center; "></td> 
