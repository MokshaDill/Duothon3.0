                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="d-md-flex">
                                            <div>
                                                ...
                                                <h5 class="card-subtitle" style="font-size:14px">Overview of Booking</h5>
                                            </div>
                                            <div class="ms-auto">
                                                <div class="dl">
                                            ...
                                            <table class="table mb-0 table-hover align-middle text-nowrap" id="example">
                                                <thead>
                                                    <tr>
                                                        ...
                                                        <th class="border-top-0">Select Trip</th>
...
<div id="popup2" class="overlay">
	<div class="popup">
		<h2 style="text-align:center; color:blue; font-weight:bold;">Update a Available Booking Details</h2>
		<a class="close" href="#">&times;</a>
		<div class="content">
			<form action="../../editTickets?id=<%=rs.getString("BookingID") %>" method="post" style="color:black; font-weight:bold;">
			    ...
			    <input type="datetime-local" class="input-form" name="DateTime" ><br>
			    		    <span style="color:black; font-weight:bold;">Reg No</span>	    <br>
			...
			.input-form{
			  ...
			  color:gray;
                                                    ...
                                                    <tr>
                                                        ...
                                                        <label class="badge bg-primary"><%=rs.getString("BookingID") %></label>
                                                        ...
                                                        <td>
                                                            <label class="badge bg-success"><%=rs.getString("RegNo") %></label>
                                                        </td>
        											    <td><%=rs.getString("Category") %>
                                                       </td>
        												<td><h4 class="badge bg-warning" style="font-size:16px;">$<%=rs.getString("price") %>.00 U.S</h4></td>
        									            <td><a href="routing.jsp"><img src="../assets/img/location.png" style="width:55px; height:40px; margin-left:15px;"></a></td>
        										     <td><a href="#popup2"><img src="../assets/img/icons8-edit-64.png" style="width:40px; height:40px;"></a></td>
                                                <td><a href="../../DeleteTicket?id=<%=rs.getString("BookingID") %>" id=""><img src="../assets/img/icons8-delete-100.png" style="width:40px; height:40px;"></a></td>
                                                    </tr>
                                                    <% }%>
                                                </tbody>
                                                   <% 	
	...
	<div class="popup">
		...
		<div class="content">
			...
			Ticket ID<br>
			    ...
			    Category<br>
			    <input type="text" class="input-form1" name="Seats"><br>
			     Price<br>
