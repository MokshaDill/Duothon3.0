                ...
                <nav class="sidebar-nav" >
                    <ul id="sidebarnav" >
                       <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link"
                           ...
                           <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link"
                                href="UserDashboard.jsp" aria-expanded="false"><i class="mdi mdi-taxi"></i><span
                    ...
                    <div class="col-6">
                        <div class="text-end upgrade-btn">
                            <a href="#popup1" class="btn btn-primary text-white"
                                target="">Add New Offer Details</a>
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="d-md-flex">
                                    <div>
                                        <h4 class="card-title">All Trip Details</h4>
                                        <h5 class="card-subtitle" style="font-size:14px">Overview of Trip Details</h5>
                                    </div>
                                    <div class="ms-auto">
                                        <div class="dl">
                                ...
                                <div class="table-responsive">
                                    <table class="table mb-0 table-hover align-middle text-nowrap" id="example">
                                        <thead>
                                            <tr>
                                            <th class="border-top-0">Offer ID</th>
                                                <th class="border-top-0">Offer</th>
...
<div id="popup2" class="overlay">
	<div class="popup">
		<h2 style="text-align:center; color:blue; font-weight:bold;">Update Trip Details</h2>
		<a class="close" href="#">&times;</a>
		<div class="content">
			<form action="../../editOffer?id=<%=rs.getString("OfferID") %>" method="post" style="color:black; font-weight:bold;">
			    <span style="color:black; font-weight:bold;">Offer</span><br>
			    <input type="text" class="input-form" name="Airline" ><br>
			      <span style="color:black; font-weight:bold;">Valid Till</span><br>
			    <input type="date" class="input-form" name="valid" ><br>
			...
			.input-form{
			  ...
			  color:gray;
                                               ...
                                               <td ><h5 class="badge bg-primary"><%=rs.getString("OfferID") %></h5></td>
                                                <td>
                                                   
												<h3 class="badge bg-secondary"><%=rs.getString("Offer") %></h3>


                                                </td>
                                                                                                <td><%=rs.getString("ValidTill") %></td>
                                                <td class="m-b-0 font-16"><%=rs.getString("Depature") %></td>
                                                ...
                                                <td><a href="../../DeleteTrip?id=<%=rs.getString("OfferID") %>" id=""><img src="../assets/img/icons8-delete-100.png" style="width:40px; height:40px;"></a></td>
...
<div id="popup1" class="overlay">
	<div class="popup1">
		<h2 style="text-align:center; color:blue; font-weight:bold;">Enter Trip Details</h2>
		<a class="close" href="#">&times;</a>
		<div class="content">
			<form action="../../Offer" method="post" style="color:black; font-weight:bold;">
			Offer ID<br>
			   ...
			   Valid Till<br>
			    <input type="datetime-local" class="input-form1" name="Airline" style="width:370px; margin:5px;"><br>
			    			    Depature<br>
			    <input type="text" class="input-form1" name="Depature" style="width:370px; margin:5px;"><br>
			       Destination<br>
			    <input type="text" class="input-form1" name="Destination" style="width:370px; margin:5px;"><br>
			    			    Date & Time<br>
			    <input type="datetime-local" class="input-form1" name="DateTime" style="width:370px; margin:5px;"><br>
			Days<br>
			    <input type="number" class="input-form1" name="days" style="width:370px; margin:5px;"><br>
			     Total<br>
