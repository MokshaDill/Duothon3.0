...
try {
	...
	e.printStackTrace();
       ...
       <table>
       <tr><td><h5 style="color:black; padding-left:80px;">Offer ID</h5></td><td><h5 style="color:black; padding-left:100px;">   <%=id %></h5></td></tr>
       ...
       <tr><td><h5 style="color:black; padding-left:80px;">Days</h5> </td><td><h5 style="color:black; padding-left:100px;"> <%=passenger %></h5></td></tr>
