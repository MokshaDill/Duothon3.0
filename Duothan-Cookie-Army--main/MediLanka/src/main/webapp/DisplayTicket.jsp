...
try {
		    ...
		    sql ="Select * from trips where OfferID ='"+id+"'";
        ...
        <div class="row">
            ...
            <div class="col-md-4 col-sm-6">
                <div class="pricingTable pink">
                    ...
                    %>
                        <h3 class="title">	        	<%=rs.getString("Offer") %></h3>
