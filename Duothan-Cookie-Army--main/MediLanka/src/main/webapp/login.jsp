...
<body background="assets/css/MediBack.jpeg" style="
  
  background-size: cover; ">
 
	<input type="hidden" id="status" value="<%=request.getAttribute("status") %>">
    <div class="box" style="top:100px;" ></div>
          <div img class="box-img" style="background-image:url(assets/css/pha.jpeg); top:100px;">
            <div class="container">
                <div class="user">
                ...
                <div class="form">
                    <form action="client_login" method="post">
                         <div class="inner-form">
                            <h4 class="memberno" style="top:90px; left:40px;">Membership ID</h4>
                              <div>
                                <input class="inputBox1"  style="top:100px; left:240px; padding-left:20px;"type="text" name="memberno">
                              </div>
                        <br>
                         <div class="inner-form">
                            <h4 class="memberno" style="top:140px; left:40px;">Role</h4>
                              <div>
                              <select class="inputBox1"  style="top:145px; left:240px; padding-left:20px;"type="text" name="memberno">
                                <option value="Customer">Pharmacy</option>
                                <option value="Driver">Citizen</option>
                        ...
                        <br>
                            <h4 class="memberno" style="top:185px; left:40px;">Username</h4>
                              <div>
                                <input class="inputBox1" type="text" name="user" style="top:195px; left:240px; padding-left:20px;">
                              </div>
                        <br> 
                            <h4 class="password" style="top:235px; left:40px;">Password</h4>
                              <div>
