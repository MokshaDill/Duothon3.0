                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="d-md-flex">
                                            <div>
                                                ...
                                                <h5 class="card-subtitle" style="font-size:14px">Overview of Customers</h5>
                                            </div>
                                            <div class="ms-auto">
                                                <div class="dl">
                                        ...
                                        <div class="table-responsive">
                                            <table class="table mb-0 table-hover align-middle text-nowrap" id="example">
                                                <thead>
													...
													<th class="border-top-0">Make Manager <i class="mdi mdi-account-settings-variant"></i></th>
...
<div id="popup2" class="overlay">
	<div class="popup">
		<h2 style="text-align:center; color:blue; font-weight:bold;">Update Customer Details</h2>
...
<div id="popup1" class="overlay">
	<div class="popup">
		<h2 style="text-align:center; color:blue; font-weight:bold;"> New Customer</h2>
		<a class="close" href="#">&times;</a>
		<div class="content">
