...
<div class="container" style="background-color: #fff; border-radius:15px; height:620px; width:2700px;  align-items:center;">
	...
	<div style=""></div>
	<div class="container-info" style="background: rgba(219, 239, 251, 0.5); border-radius:10px;  margin-top:40px; width:1295px; height: 400px; color:blue;" ><ul><li><p style="margin:10px 30px 0px 30px; color:black;">Wear a mask: Wear a mask that covers your nose and mouth in public indoor settings and crowded outdoor areas, especially when social distancing is difficult to maintain.</p></li><li><p style="margin:10px 30px 0px 30px; color:black;">Wash your hands frequently: Wash your hands with soap and water for at least 20 seconds, especially after being in a public place or touching common surfaces. <a href="">Portal here</a> before departure and to declare their travel history (of the past 14 days).</p></li><li><p style="margin:10px 30px 0px 30px; color:black;">Ensure that the weight of your luggage does not exceed the permitted weight. (Travel luggage - 30 kg, Hand luggage – 7kg)</p></li>
	</p></li><li><p style="margin:10px 30px 0px 30px; color:black;"> Get vaccinated: Vaccines are highly effective at preventing severe illness, hospitalization, and death from COVID-19. Check with your local health authorities to see if you are eligible for a vaccine.</p></li><li><p style="margin:10px 30px 0px 30px; color:black;">
...
<li><p style="margin:10px 30px 0px 30px; color:black;">Drivers are recommended to follow respiratory etiquette and all safety standards like wearing masks and gloves, follow social distancing, and avoid touching the eyes, nose, and mouth.</p></li>
<li><p style="margin:10px 30px 0px 30px; color:black;">Drivers are not allowed to take breaks in high alert or red zone areas.</p></li>
      </div>
        ...
        <div class="row">
            ...
            <div class="col-md-4 col-sm-6">
                <div class="pricingTable pink">
                    ...
                    %>
                        <h3 class="title">	        	<%=rs.getString("year") %>%</h3>
                 ...
                 <li>Medicine ID : <%=rs.getString("id") %>     </li>            
                <li> Medicine : <%=rs.getString("medicine") %></li>
                <li> company : <%=rs.getString("company") %></li>
                <li> Category : <%=rs.getString("category") %></li>
                        <li>Quantity : <%=rs.getString("quantity") %></li>
                        <li>Per Delivery : $<%=rs.getString("Total") %>.00 U.S</li>
                    </ul>
...
@keyframes moveInBottom {
    ...
    100% {
        ...
        transform: translateY(0px);
                	    ...
                	    sessionPay.setAttribute("Depature",company);
                	    sessionPay.setAttribute("Destination",category);
                	    sessionPay.setAttribute("DateTime",quantity);
                	    sessionPay.setAttribute("Airline",medicine);
                	   %>
                    </div>
                </div>
            </div>
...
<span style="color:#fff; font-size:20px; margin-top:0px; margin-left:179px;">MEDICINE PASS</span>
...
border-radius: 30px;"><br>
    <span style="color:#fff; font-size:20px;  margin-left:30px ">MEDICINE PASS</span>
