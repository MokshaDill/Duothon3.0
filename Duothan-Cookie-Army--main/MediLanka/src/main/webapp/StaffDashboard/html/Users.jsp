      ...
      <nav id="navbar" class="navbar">
        <ul>
          ...
          <li class="dropdown"><a href="../../about.jsp"><span>About Us</span> <i class="bi bi-chevron-down dropdown-indicator"></i></a>
            <ul>
				<li><a href="../about.html">Medicine</a></li>
        ...
        <div class="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                try {
        		    ...
        		    sql ="Select * from citizen where role ='citizen'";
                            ...
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div class="d-md-flex">
                                            <div>
                                                <h4 class="card-title">Citizen Details</h4>
                                                <h5 class="card-subtitle" style="font-size:14px">Overview of Citizen</h5>
                                            </div>
                                            <div class="ms-auto">
                                                <div class="dl">
                                            ...
                                            <table class="table mb-0 table-hover align-middle text-nowrap" id="example">
                                                <thead>
                                                    <tr>
                                                        ...
                                                        <th class="border-top-0">Pharmacy</th>
                                                        <th class="border-top-0">Phone</th>
                                                        <th class="border-top-0">Email</th>
                                                        <th class="border-top-0">Address</th>
                                                        <th class="border-top-0">Country</th>
													   <th class="border-top-0">Edit <i class="mdi mdi-ethernet-cable-off"></i></th>
													<th class="border-top-0">Make Pharmacy Member <i class="mdi mdi-account-settings-variant"></i></th>
...
<div id="popup2" class="overlay">
	<div class="popup">
		<h2 style="text-align:center; color:blue; font-weight:bold;">Update Citizen Details</h2>
		...
		<div class="content">
			<form action="../../editUsers?id=<%=rs.getString("memberID") %>" method="post" style="color:black; font-weight:bold;">
			    ...
			    <input type="text" class="input-form" name="name" ><br>
			    			    					   <span style="color:black; font-weight:bold;">  pharmacy</span>	  <br>
...
<div id="popup1" class="overlay">
	<div class="popup">
		<h2 style="text-align:center; color:blue; font-weight:bold;"> New Citizen</h2>
		<a class="close" href="#">&times;</a>
		<div class="content">
			...
			MemberID<br>
			    ...
			    Name<br>
			    <input type="text" class="input-form1" name="name" style="width:370px; margin:5px;"><br>
			    Pharmacy Name<br>
			    <input type="text" class="input-form1" name="dob" style="width:370px; margin:5px;"><br>
			    			    Phone<br>
			    <input type="number" class="input-form1" name="phone" style="width:370px; margin:5px;"><br>
			    			    Email<br>
			    <input type="email" class="input-form1" name="email" style="width:370px; margin:5px;"><br>
			    Address<br>
			    <input type="text" class="input-form1" name="address" style="width:370px; margin:5px;"><br>
			     Country<br>
			    <input type="text" class="input-form1" name="Country" style="width:370px; margin:5px;"><br>

			   Customer <input type="radio" Style="margin:0px 40px 0px 10px;" name="role" value="Customer">Driver<input type="radio" class="" Style="margin:0px 40px 0px 10px;"name="role" value="Driver"><br>
