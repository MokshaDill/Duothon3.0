                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="d-md-flex">
                                            <div>
                                                ...
                                                <h5 class="card-subtitle" style="font-size:14px">Overview of Managers</h5>
                                            </div>
                                            <div class="ms-auto">
                                                <div class="dl">
                                                ...
                                                <thead>
                                                    <tr>
                                                        ...
                                                        <th class="border-top-0">Country</th>
														                                                ...
														                                                <th class="border-top-0">Make Driver <i class="mdi mdi-account-settings-variant"></i></th>
													<th class="border-top-0">Make Customer <i class="mdi mdi-account-settings-variant"></i></th>
...
<div id="popup2" class="overlay">
	<div class="popup">
		<h2 style="text-align:center; color:blue; font-weight:bold;">Update Manager Details</h2>
...
<div id="popup1" class="overlay">
	<div class="popup">
		<h2 style="text-align:center; color:blue; font-weight:bold;"> New Manager</h2>
		<a class="close" href="#">&times;</a>
		<div class="content">
			...
			MemberID<br>
			    ...
			    Date Of Birth<br>
			    <input type="date" class="input-form1" name="dob" style="width:370px; margin:5px;"><br>
			    			    Phone<br>
			   ...
			   Customer <input type="radio" Style="margin:0px 30px 0px 5px;" name="role" value="Customer">Driver<input type="radio" class="" Style="margin:0px 30px 0px 5px;"name="role" value="Driver">Manager<input type="radio" class="" Style="margin:0px 0px 0px 5px;"name="role" value="Manager"><br>
