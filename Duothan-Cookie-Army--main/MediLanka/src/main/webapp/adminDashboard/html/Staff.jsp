        ...
        <div class="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                try {
        		    ...
        		    sql ="Select * from citizen where role ='pharmacy'";
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="d-md-flex">
                                            <div>
                                                ...
                                                <h5 class="card-subtitle" style="font-size:14px">Overview of Drivers</h5>
                                            </div>
                                            <div class="ms-auto">
                                                <div class="dl">
...
<div id="popup2" class="overlay">
	<div class="popup">
		<h2 style="text-align:center; color:blue; font-weight:bold;">Update Pharmacy Details</h2>
...
<div id="popup1" class="overlay">
	<div class="popup">
		<h2 style="text-align:center; color:blue; font-weight:bold;"> New Driver</h2>
		<a class="close" href="#">&times;</a>
		<div class="content">
