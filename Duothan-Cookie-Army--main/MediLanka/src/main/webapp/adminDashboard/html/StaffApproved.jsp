        ...
        <div class="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                try {
        		    ...
        		    sql ="Select * from citizen where (role ='pharmacy') And status='pending'";
                            ...
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div class="d-md-flex">
                                            <div>
                                                <h4 class="card-title">Pharmacy Approval Details</h4>
                                                <h5 class="card-subtitle" style="font-size:14px">Overview of All the Pharmacy</h5>
                                            </div>
                                            <div class="ms-auto">
                                                <div class="dl">
	...
	<div class="popup">
		...
		<div class="content">
			...
			MemberID<br>
			   ...
			   Manager <input type="radio" Style="margin:0px 40px 0px 10px;" name="Role" value="Manager">Driver<input type="radio" class="" Style="margin:0px 40px 0px 10px;"name="role" value="Driver"><br>
