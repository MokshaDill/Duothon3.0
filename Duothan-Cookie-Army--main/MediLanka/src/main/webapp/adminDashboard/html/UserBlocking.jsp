                            ...
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div class="d-md-flex">
                                            <div>
                                                <h4 class="card-title">Block Users Details</h4>
                                                <h5 class="card-subtitle" style="font-size:14px">Overview of Block Users</h5>
                                            </div>
                                            <div class="ms-auto">
                                                <div class="dl">
	...
	<div class="popup">
		...
		<div class="content">
			...
			MemberID<br>
			   ...
			   Customer <input type="radio" Style="margin:0px 40px 0px 10px;" name="role" value="Customer">Manager<input type="radio" class="" Style="margin:0px 40px 0px 10px;"name="role" value="Manager"><br>
